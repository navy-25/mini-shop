...
@section('nav_bottom_btn')
    <button type="button" onclick="$('#btn_submit').trigger('click')" class="ms-auto btn btn-success d-flex full-round px-4">
        <small>Pesan</small>
    </button>
@endsection
@section('content')
        ...
        <div class="card mb-3">
            <div class="card-body">
                ...
                <div class="form-group mb-3">
                    ...
                    <input type="text" class="form-control" name="name" value="" placeholder="nama lengkap anda" required>
                </div>
                <div class="form-group mb-3">
                    <label for="" class="mb-1">Whatsapp<span class="text-danger">*</span></label>
                    <input type="text" class="form-control" name="phone" value="" placeholder="0821xxxxxxxx" required>
                </div>
                <div class="form-group mb-3">
                    <label for="" class="mb-1">Alamat lengkap<span class="text-danger">*</span></label>
                    <textarea name="address" id="" class="form-control" cols="30" rows="3" required placeholder="Ds. xxx, Kec. xxx, RT.00, RW.00, No. xx - (Patokan rumah)"></textarea>
                </div>
                <div class="form-group mb-3">
                    <label for="" class="mb-1">Catatan<span>(optional)</span></label>
                    <textarea name="noted" id="" class="form-control" cols="30" rows="3" placeholder="ex. Kantong plastiknya di doble ya kak"></textarea>
                </div>
            </div>
        </div>
