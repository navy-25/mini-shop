            ...
            $('#cart_list').append(`
                    ...
                    <div class="row m-0" id="colom_` + data_card.id_input.replace('#', '') + `">
                        ...
                        <div class="col-8 col-md-9 col-lg-10 px-0">
                            <div class="px-2">
                                ...
                                <input type="hidden" id="` + data_card.id_price.replace('#', '') + `" value="` +
                data_card.price + `">
                ...
                `">
                            ...
                            <div class="d-flex mt-1 px-0 w-100">
                                    <button class="btn btn-secondary me-auto m-2 my-auto bg-secondary p-0 rounded text-white" type="button" onclick="delete_product('colom_` +
                data_card.id_input
                .replace('#', '') + `','` + key + `')"
