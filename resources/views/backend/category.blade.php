...
<div class="card">
    <div class="card-header py-3 px-3">
        <div class="row">
            ...
            <div class="col-6 col-md-6 col-lg-6 d-flex">
                <a title="tambah" href="#" onclick="createData('{{ route('admin.category.store') }}')"
    ...
    <script>
        ...
        var colums_data =
            [
                ...
                {data: 'thumbnail_image', name: 'categories.thumbnail'},
                {data: 'name', name: 'categories.name'},
                {data: 'status_data', name: 'categories.status'},
